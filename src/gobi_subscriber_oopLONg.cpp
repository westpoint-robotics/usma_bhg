...
string GobiBHG::makeTimestamp()
{
    ...
    int e=sprintf (dateTime, "%d%02d%02d_%02d%02d%02d_%03d", local_tm.tm_year + 1900,
                   local_tm.tm_mon + 1, local_tm.tm_mday, local_tm.tm_hour, 
                   local_tm.tm_min, local_tm.tm_sec, ros_millisec);
    return dateTime; 
}
